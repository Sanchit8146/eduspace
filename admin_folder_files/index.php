...
<body style="user-select:none;" spellcheck="false"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card card-topline-green">
                                        <div class="card-head">
                                            <header>Accounts Created</header>
                                            <span id="status"></span>
                                        </div>
                                        <div class="card-body ">
                                                ...
                                                <table class="table table-striped custom-table table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if (mysqli_num_rows($result) == 0) {
                                                            echo "<tr style='text-align:center;'><td colspan=10 style='font-size:25px;'>No Accounts Created Yett!!!</td></tr>";
                                                        } else {
                                                        ...
                                                        <td contenteditable="true"
                                                            onBlur="updateValue(this,'first_name','<?php echo $id; ?>')">
                                                            <?php echo $first_name; ?>
                                                        <td contenteditable="true"
                                                            onBlur="updateValue(this,'last_name','<?php echo $id; ?>')">
                                                            <?php echo $last_name; ?>
                                                        <td contenteditable="true"
                                                            onBlur="updateValue(this,'email','<?php echo $id; ?>')">
                                                            <?php echo $email; ?>
                                                        <td contenteditable="true"
                                                            onBlur="updateValue(this,'pwd','<?php echo $id; ?>')">
                                                            <?php echo $pwd; ?>
                                                        </td>
                                                        <?php
                                                                if ($user_type == "P") {
                                                        ...
                                                        <td><a href="idproof/<?php echo $row["idproof"]; ?>"
                                                                target="_blank"><img
                                                                    src="idproof/<?php echo $row["idproof"]; ?>"
                                                                    height="60px" width="100px" alt="image"></a></td>
                                                        <?php echo "<td style='text-align:center;'>";
                                                                if ($status == 0) {
                                                                    echo "<a href='approveuser.php?id=$uniq_id' class='btn btn-info btn-sm'>Approve</a>";
                                                                } else {
                                                                    echo "<a href='unapproveuser.php?id=$uniq_id' class='btn btn-dark btn-sm'>UnApprove</a>";
                                                                }
                                                                echo "<a onclick='confbox($uniq_id)' class='btn btn-danger btn-sm'>Delete!!!</a></td>
    ...
    <script>
    function confbox(uniqid) {
        var r = confirm("Press Ok to delete the user!!!!");
        if (r == true) {
            location.href = "deleteuser.php?id=" + uniqid + "";
        } else {
