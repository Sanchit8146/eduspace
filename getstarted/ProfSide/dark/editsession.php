...
<body style="user-select:none;" spellcheck="false"
    ...
    $sid = $_GET["id"];
    $query = mysqli_query($db, "select * from session where s_id=$sid");
                ...
                <div class="sidemenu-container navbar-collapse collapse fixed-menu">
                    <div id="remove-scroll" class="left-sidemenu">
                        <ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false"
                            ...
                            <li class="nav-item">
                                <a href="graph/Graphs.php" class="nav-link nav-toggle"> <i class="fa fa-percent"></i>
                                    <span class="title">See average</span>
                                </a>
                            </li>
                            ...
                            <li class="nav-item active">
                                <a class="nav-link nav-toggle" href="showsession.php"> <i
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card card-topline-purple" style=" padding-left:5%; padding-right:8%;">
                                        <form action="updatesession.php" method="POST" name="session">
                                            <div class="card-head row">
                                                <header class="col-md-6">
                                                    <label>Edit the name of your class</label>
                                                    <input type="text" class="form-control" name="cname"
                                                        value="<?php echo $name; ?>" placeholder="Class Name" required>
                                                </header>
                                                <header class="col-md-6">
                                                    <label>Edit the link of your class</label>
                                                    <input type="hidden" value="<?php echo $s_id; ?>" name="s_id"
                                                        readonly>
                                                    <input type="text" class="form-control" value="<?php echo $link; ?>"
                                                        name="link" placeholder="Paste your link here" required>
                                                </header>
                                                <header class="col-md-6">
                                                    <label>Edit the date of your class</label>
                                                    <input type="date" value="<?php echo $date; ?>" class="form-control"
                                                        name="date" required>
                                                </header>
                                                <header class="col-md-6">
                                                    <label>Edit the time for your class</label>
                                                    <input type="time" value="<?php echo $time; ?>" class="form-control"
                                                        name="time" required>
                                                </header>
                                                <div class="col-md-4"></div>
                                                <header class="col-md-4">
                                                    <input type="submit"
                                                        style="display:block;margin:20px auto 10px auto ;"
                                                        value="Update" class="btn btn-circle btn-success btn-lg">
                                                </header>
                                                <div class="col-md-4"></div>
                                            </div>
                                        </form>
