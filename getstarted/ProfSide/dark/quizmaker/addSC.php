        ...
        <div class="page-content-wrapper">
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="card card-topline-green" style="height:650px;">
                            <div class="card-head">
                                <?php
                            ...
                            <div class="card-body ">
                                <form action="writeSC.php" method="POST">
                                    <div class="grid-container">
                                        ...
                                        <div class="grid-item" style="grid-column:1/ 5;justify-content:center;">
                                            <ol type="A">
                                                <li>
                                                    <div>
                                        ...
                                        <div class="grid-item1">
                                            <select class="form-control" id="correct" name="correctanswer" required>
                                                <option hidden selected disabled value>
                                                    Correct Answer
                                                </option>
                                                <option value="<?php echo $aid + 1; ?>">A</option>
                                                <option value="<?php echo $aid + 2; ?>">B</option>
                                                <option value="<?php echo $aid + 3; ?>">C</option>
                                                <option value="<?php echo $aid + 4; ?>">D</option>
                                            </select>
                                        </div>
                                        <!-- <div class="grid-item">
