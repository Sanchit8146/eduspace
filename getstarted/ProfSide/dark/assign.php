...
<body style="user-select:none;" spellcheck="false"
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Assign Work</div>
                            </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped custom-table table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $sql = "SELECT * FROM quiz where prof_id='$profid'";
                                                        ...
                                                        if (mysqli_num_rows($result) == 0) {
                                                            ...
                                                            <td></td>";
                                                                ...
                                                                if ($status == 0) {
                                                                    echo "<a href='assignwork.php?id=$quiz_id' class='btn btn-warning btn-sm'>Assign</a>";
                                                                } else {
                                                                    echo "<a href='unassignwork.php?id=$quiz_id' class='btn btn-dark btn-sm'>Unassign</a>";
                                                                }
                                                                echo "<a onclick='confbox($quiz_id)' class='btn btn-danger btn-sm'>Delete!!!</a></td>
    ...
    function confbox(qid) {
        var r = confirm("Press Ok to delete the quiz!!!!");
        if (r == true) {
