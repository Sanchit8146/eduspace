                ...
                <div class="sidemenu-container navbar-collapse collapse fixed-menu">
                    <div id="remove-scroll" class="left-sidemenu">
                        <ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false"
                            ...
                            <li class="nav-item">
                                <a href="createsession.php" class="nav-link nav-toggle "> <i
                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Show Sessions</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped custom-table table-hover">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $counter = 1;
                                                        $sql = "select * from session where prof_id='$profid' order by s_id ASC";
                                                        $result = mysqli_query($db, $sql);
                                                        if (mysqli_num_rows($result) == 0) {
                                                            echo "<tr style='text-align:center;'><td colspan=12 style='font-size:25px;'>No Session Created Yett!!!</td></tr>";
                                                        } else {
                                                            ...
                                                            <td>$date</td>
                                                            <td>$time</td>
                                                            <td><a href='editsession.php?id=$s_id'><i class='far fa-edit' style='color:yellow;'></i></a></td>
                                                            <td><a onclick='confbox($s_id)'><i class='far fa-trash-alt' style='color:red;'></i></a></td>
                                                          </tr>";
                                                                $counter++;
                                                            }
                                                        }
