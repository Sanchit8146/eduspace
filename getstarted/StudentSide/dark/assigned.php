                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Assigned Work</div>
                            </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped custom-table table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $sql = "SELECT * FROM quiz where status=1";
                                                        $result = mysqli_query($db, $sql) or die("Bad Query");
                                                        $counter = 1;

                                                        //outprint each quiz
                                                        if (mysqli_num_rows($result) == 0) {
                                                            echo "<tr style='text-align:center;'><td colspan=11 style='font-size:25px;'>No Quizzes Assigned Yett!!!</td></tr>";
                                                        } else {
                                                            ...
                                                            <td></td>";
                                                                echo "<td>";
                                                                $sql1 = "SELECT * FROM quiz where quizname='$quizname' and prof_id='$prof_id'";
                                                                $result1 = mysqli_query($db, $sql1);
                                                                $rows = mysqli_fetch_array($result1);
                                                                extract($rows);
                                                                $checkquery = mysqli_query($db, "select * from result where quiz_id='$quiz_id' and uniq_id='$uniqid'");
                                                                if (mysqli_num_rows($checkquery) > 0) {
                                                                    echo "<button class='btn btn-dark btn-xs' disabled>Attempted</button>";
                                                                } else {
                                                                    echo "<a href='attempt.php?id=$quiz_id&profid=$prof_id' class='btn btn-info btn-xs'>Attempt</a>";
                                                                }
                                                                echo " </td>
                                                                </tr>";
                                                                $counter++;
